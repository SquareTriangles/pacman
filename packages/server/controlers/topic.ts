...
import { TopicTable, UserTable } from '../db'
...
export const getAllTopic  = async () => TopicTable.findAll({ order: [ ['updatedAt', 'DESC'] ],  include: [ UserTable ] })
export const getTopicById  = async (id: string) => TopicTable.findByPk(id, { include: [ UserTable ] })
